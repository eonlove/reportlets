...
<![CDATA[with tmp as (
select
distinct trunc(max(jysj)) as maxdate,
trunc(max(jysj))-6 as rq7,
trunc(max(jysj))-29 as rq30, 
trunc(max(jysj),'mm') as rqby 
from zl_spls)

select 
to_number(to_char(jysj,'HH24')) as hh,
concat(to_char(jysj,'HH24'),'时') as hhshow,
sum(ysje) as xse,
sum(jslr) as jslr,
count(distinct ddh) as ddh,
sum(ysje)/count(distinct ddh) as kdj

from spls_lrhy a,tmp
where 1=1 ${if(len(rq)==0,"and rq =tmp.maxdate","and rq = to_date('"+rq+"','YYYY-MM-DD')")}
and 1=1 ${if(len(unit)==0,"","and md='"+unit+"'")}
and 1=1 ${if(len(yjfl)==0,"","and yjfl = '"+yjfl+"'")}

group by to_number(to_char(jysj,'HH24')),concat(to_char(jysj,'HH24'),'时')
order by hh asc]]></Query>
</TableData>
...
<BoundsAttr x="364" y="4" width="80" height="42"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
...
<Attributes>
<![CDATA[=sql("oracle","select distinct trunc(max(rq)) from spls_lrhy",1,1)]]></Attributes>
</O>
</widgetValue>
</InnerWidget>
...
<BoundsAttr x="260" y="4" width="94" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<BoundsAttr x="80" y="25" width="100" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<ChartSummaryColumn name="DDH" function="com.fr.data.util.function.NoneFunction" customName="单量"/>
...
<TemplateID TemplateID="299c4814-9c7f-4cb4-a847-4e63b1659ad0"/>
<TemplateIdAttMark class="com.fr.base.iofileattr.TemplateIdAttrMark">
<TemplateIdAttMark TemplateId="635663fe-7cce-4af3-b11a-8a9365280f45"/>
</TemplateIdAttMark>
</Form>
